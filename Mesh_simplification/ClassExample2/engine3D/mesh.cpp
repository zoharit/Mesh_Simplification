...
Mesh::Mesh(const std::string& fileName,bool d,int max_faces)
{
	IndexedModel model = OBJModel(fileName,d, max_faces).ToIndexedModel() ;
	InitMesh(model);
}
...
Mesh::Mesh(Vertex* vertices, unsigned int numVertices, unsigned int* indices, unsigned int numIndices)
{
	...
	std::cout << model.normals.size() << std::endl;
