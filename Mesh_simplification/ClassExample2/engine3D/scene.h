...
public:
	...
	void addShape(const std::string& fileName,bool d,int max_faces);
	void addShape(const std::string & fileName, const std::string & textureFileName, bool d, int max_faces);
